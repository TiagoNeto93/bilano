ChatMix — game vs voice audio balance for Windows
==================================================

A lightweight ChatMix dial (like SteelSeries Sonar's, minus the bloat).
One slider balances your game audio against your voice-chat apps. No
installer, no audio driver, no runtime — it's a single .exe.


HOW TO RUN
----------
1. Double-click  chatmix.exe
...
Settings are saved to:  %APPDATA%\chatmix\config.json
